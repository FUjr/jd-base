...
function Combin_All {
  ...
  export JDJOY_SHARECODES=$(Combin_Sub ForOtherJoy "dRa-oUXgKP0N90gWG8RPGQ==")
  ...
  export JD_CASH_SHARECODES=$(Combin_Sub ForOtherCash "9aKxuV0nvkG1@dE90Ow@dE90O6zy@eU9Yab-7b_wmozuAwiVGhw")
